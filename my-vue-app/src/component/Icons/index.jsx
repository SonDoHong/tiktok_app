...
const PlusIcon = ({ className, width = "3.2rem", height = "3.2rem" }) => {
    return (
        <svg
            className={className}
            width={width}
...
const UserGroupIcon = ({ className, width = "3.2rem", height = "3.2rem" }) => {
    return (
        <svg
            className={className}
            width={width}
...
const CheckIcon = ({ className, width = "1.4rem", height = "1.4rem" }) => {
    return (
        <svg
            className={className}
            width={width}
...
const ArrowUpIcon = ({ className, width = "1.6rem", height = "1.6rem" }) => {
    return (
        <svg
            className={className}
            width={width}
...
const DesktopIcon = ({ className, width = "2.1rem", height = "2.1rem" }) => {
    return (
        <svg
            className={className}
            width={width}
...
const MobileIcon = ({ className, width = "2.1rem", height = "2.1rem" }) => {
    return (
        <svg
            className={className}
            width={width}
...
const XMarkIcon = ({ className, width = "2rem", height = "2rem" }) => {
    return (
        <svg
            className={className}
            width={width}
...
const MusicIcon = ({ className, width = "1.4rem", height = "1.4rem" }) => {
    return (
        <svg
            className={className}
            width={width}
